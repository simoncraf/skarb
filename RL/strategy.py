...
def get_strategy(turbulence):
    ...
    for col in df_tech.columns:
        df[col] = df_tech[col]
    '''
    df2 = pd.read_csv('gym-example/praying_trade.csv',sep=';')
